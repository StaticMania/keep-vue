...
import PaginationGoTo from "~/src/components/Pagination/PaginationGoTo.vue";
...
import PaginationNavigator from "~/src/components/Pagination/PaginationNavigator.vue";
</script>
<template>
