...
<template>
  <DialogClose
    ...
    :class="
      cn(
        'data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none',
        props.class,
      )
    ">
    <slot>
      <svg
        ...
        class="size-5 fill-metal-600 dark:fill-white"
        viewBox="0 0 256 256">
        <path
