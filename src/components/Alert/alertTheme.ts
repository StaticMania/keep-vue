...
export const alertTheme: KeepAlertTheme = {
  colorWithBg: {
    primary:
      "bg-primary-50 border border-primary-200 dark:border-primary-800 dark:bg-primary-900/30",
    secondary:
      "bg-metal-50 border border-metal-200 dark:border-metal-800 dark:bg-metal-900/30",
    success:
      "bg-success-25 border border-success-200 dark:border-success-800 dark:bg-success-900/30",
    warning:
      "bg-warning-25 border border-warning-200 dark:border-warning-800 dark:bg-warning-900/30",
    error:
      "bg-error-25 border border-error-100 dark:border-error-800 dark:bg-error-900/30",
  },
  colorWithOutBg: {
