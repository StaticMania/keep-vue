...
const props = defineProps<RangeCalendarNextProps & ClassProps>();
  ...
  <RangeCalendarNext
    ...
    <slot>
      <svg
        ...
        class="absolute right-1.5 h-4 w-4"
        viewBox="0 0 256 256">
        <path
