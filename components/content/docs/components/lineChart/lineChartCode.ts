const defaultLineChartCode = {
  "LineChartComponent.vue(ts)": `<script setup lang="ts">
import {
  CategoryScale,
  ChartTooltip,
  KeepChart,
...
const chartOptions = reactive({
  ...
  plugins: {
    ...
    title: {
      display: true,
      text: 'Keep Vue Default Line Chart'
    },
    legend: {
      display: false
    },
...
`,
  "LineChartComponent.vue(js)": `<script setup>
import {
  CategoryScale,
  ChartTooltip,
  KeepChart,
...
<template>
  <Line id="defaultAreaChart" :options="chartOptions" :data="chartData" :plugins="[hoverLine]" />
</template>`,
};
...
<template>
  <Line id="hoverLine" :options="chartOptions" :data="chartData" :plugins="[hoverLine as any]" />
</template>`,
  "LineChartComponent.vue(js)": `<script setup>
import {
  CategoryScale,
...
<template>
  <Line id="hoverLine" :options="chartOptions" :data="chartData" :plugins="[hoverLine]" />
</template>`,
};

export { defaultLineChartCode, doubleLineChartCode };
