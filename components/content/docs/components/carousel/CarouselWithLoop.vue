...
import { CarouselWithLoopCode } from "./carouselCode";
</script>

<template>
  <CodeHighlightWithPreview :code="CarouselWithLoopCode">
      ...
      <CarouselSlides>
        <CarouselItem v-for="(_, index) in 5" :key="index">
          <div
            ...
            <h1
              class="text-heading-1 font-medium text-metal-900 dark:text-white">
              {{ index + 1 }}
            </h1>
          </div>
        </CarouselItem>
