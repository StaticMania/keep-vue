...
import { CustomizeCircleProgressCode } from "./progressCode";
</script>
<template>
  <CodeHighlightWithPreview :code="CustomizeCircleProgressCode">
    <div class="mx-auto flex max-w-lg items-center justify-center space-y-4">
